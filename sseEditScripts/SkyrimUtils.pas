{
  ...
  created by AngryAndConflict/Martinezer, released under the MIT License at https://github.com/AngryAndConflict/skyrim-utils
  
  Besides the notice above, I haven't edited this script. This is from 23/11/2021, so if there's a new version in the repo above, overwriting this one is recommended
